...
// Jake.L, DATE20160906, Define project battery capacity for 3rd apk, DATE20160906-01 START
#if defined (CONFIG_PROJECT_P7203)
#define TINNO_BATTERY_CAPACITY  3000    // 3000mAh
#elif defined (CONFIG_PROJECT_I9031)
#define TINNO_BATTERY_CAPACITY  3000    // 3000mAh
#elif defined (CONFIG_PROJECT_P7771)
#define TINNO_BATTERY_CAPACITY  3000    // 3000mAh
#elif defined (CONFIG_PROJECT_P7611)
#define TINNO_BATTERY_CAPACITY  3000    // 3000mAh
#elif defined (CONFIG_PROJECT_V3967) || defined (CONFIG_PROJECT_V3969)
	 || defined (CONFIG_PROJECT_V12BN) || defined (CONFIG_PROJECT_V11BNLITE)
#define TINNO_BATTERY_CAPACITY  3000    // 3000mAh
#elif defined (CONFIG_PROJECT_V12BNLITE)
#define TINNO_BATTERY_CAPACITY  2900    // 2900mAh
#else
#define TINNO_BATTERY_CAPACITY  2500    // 2500mAh
#endif  /* CONFIG_PROJECT_P7203 */
// Jake.L, DATE20160906-01 END
				       ...
				       union power_supply_propval *val)
{
	...
	case POWER_SUPPLY_PROP_STATUS:
        ...
        #endif  /* CONFIG_TINNO_BATTERY_CMD_DEBUG */
		val->intval = get_prop_batt_status(chip);
		pr_info("POWER_SUPPLY_PROP_STATUS = %d \n",val->intval );
		break;
	...
	case POWER_SUPPLY_PROP_MAX_PULSE_ALLOWED:
		...
		break;
	// Jake.L, DATE20160906, NOTE, DATE20160906-01 START
...
static irqreturn_t usbin_uv_handler(int irq, void *_chip)
{
	...
	if ((reg & USBIN_UV_BIT) && (reg & USBIN_SRC_DET_BIT)) {
		...
		pr_smb(PR_STATUS, "setting usb psy health UNSPEC_FAILURE\n");
		rc = power_supply_set_health_state(chip->usb_psy,
				POWER_SUPPLY_HEALTH_UNSPEC_FAILURE);
		if (rc)
			pr_err("Couldn't set health on usb psy rc:%d\n", rc);
