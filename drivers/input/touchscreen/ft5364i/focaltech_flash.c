...
static unsigned char CTPM_FW[] = {
	...
	#include "YEJI_FT5346I_V3941_V11_D01_20170330_app.i"
#elif defined(CONFIG_PROJECT_V12bn)
	#include "FT5346DQQ_V12BN_ID0X80_V01_D01_20170614_app.i"
#elif defined(CONFIG_PROJECT_V12bnlite)
	#include "FT5346DQQ_V12LITE_ID0X80_V02_D01_20170525_app.i"
#elif defined(CONFIG_PROJECT_V11bnlite)
	#include "5446_Ref_V11BN_V01_D01_20170605_app.i"
#else
	#include "FT5346DQQ_V12LITE_ID0X80_V02_D01_20170525_app.i"   //temp for V11
#endif
};
...
//begin <add for update failed><20160627><>;xiongdajun
	...
	|| defined(CONFIG_PROJECT_V11bnlite) \
	|| defined(CONFIG_PROJECT_V12bnlite) \
	|| defined(CONFIG_PROJECT_V12bn)
	if (chip_id == 0)
		chip_id = 0x54;
#endif
