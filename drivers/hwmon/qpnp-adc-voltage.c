			...
			struct device_attribute *devattr, char *buf)
{
	...
	// pony.ma, DATE20161026, printk USBIN voltage, DATE20161026-01 START
	if(attr->index == USBIN)
		pr_info("channel = %d,USB_INPUT_VOLTAGE_NOW = %lld \n",attr->index,result.physical );
	// pony.ma, DATE20161026-01 END
