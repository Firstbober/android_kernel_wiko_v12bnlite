...
extern unsigned mipi_switch_gpio_oe;
extern unsigned mipi_switch_gpio_sel;	
...
//BEGIN<20170503><add imx376>liaoshuang add 
#if 1
	if((chipid == 0x0376) && (!strncmp(s_ctrl->sensordata->sensor_name, "imx376_sunny_v12bn", sizeof("imx376_sunny_v12bn"))))
	{
		unsigned short addr_temp = 0;
		addr_temp = sensor_i2c_client->cci_client->sid;
		sensor_i2c_client->cci_client->sid = 0xA0 >>1;
		...
		rc = sensor_i2c_client->i2c_func_tbl->i2c_read(
            ...
            if(_mid == 0x01)
                       pr_err("mid of camera is imx376_sunny_v12bn \n");
            else
                        return -ENODEV;
	...
	if((chipid == 0x0376) && (!strncmp(s_ctrl->sensordata->sensor_name, "imx376_ofilm_v12bn", sizeof("imx376_ofilm_v12bn"))))
		
	{
		...
		rc = sensor_i2c_client->i2c_func_tbl->i2c_read(
            ...
            if(_mid == 0x11)
                       pr_err("mid of camera is imx376_ofilm_v12bn \n");
            else
                        return -ENODEV;
	...
	if((chipid == 0x3103) && (!strncmp(s_ctrl->sensordata->sensor_name, "s5k3p3st_ofilm_v11bnlite", sizeof("s5k3p3st_ofilm_v11bnlite"))))		
	{
		unsigned short addr_temp = 0;
		addr_temp = sensor_i2c_client->cci_client->sid;
		...
		rc = sensor_i2c_client->i2c_func_tbl->i2c_read(
            ...
            if(_mid == 0x11)
                       pr_err("mid of camera is s5k3p3st_ofilm_v11bnlite \n");
            else
                        return -ENODEV;
		...
		if((chipid == 0x3103) && (!strncmp(s_ctrl->sensordata->sensor_name, "s5k3p3st_sunny_v11bnlite", sizeof("s5k3p3st_sunny_v11bnlite"))))		
	{
		unsigned short addr_temp = 0;
		addr_temp = sensor_i2c_client->cci_client->sid;
		...
		rc = sensor_i2c_client->i2c_func_tbl->i2c_read(
            ...
            if(_mid == 0x01)
                       pr_err("mid of camera is s5k3p3st_sunny_v11bnlite \n");
            else
                        return -ENODEV;
	...
	//BEGIN<20150826><V12bn project camera id 1 is front flash >xiongdajun 
