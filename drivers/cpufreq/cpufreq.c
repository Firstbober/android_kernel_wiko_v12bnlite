...
extern void tinno_cpufreq_trace(struct cpufreq_policy *policy,
				  ...
				  unsigned int cpu, struct device *dev)
{
	...
	if (has_target()) {
		...
		#if defined (CONFIG_TINNO_CPU_TRACE)
		//printk("T_PERF cpu_f add CPU[%d] %dkHz, [%d - %dkHz]\n", 
		//	policy->cpu, policy->cur, policy->min, policy->max);
		tinno_cpufreq_trace(policy, policy->cur);
		#endif  /* CONFIG_TINNO_CPU_TRACE */
			    ...
			    unsigned int relation)
{
	...
	#if defined (CONFIG_TINNO_CPU_TRACE)
	//printk("T_PERF cpu_f target CPU[%d] %dkHz, [%d - %dkHz]\n", 
	//	policy->cpu, target_freq, policy->min, policy->max);
	tinno_cpufreq_trace(policy, target_freq);
	#endif  /* CONFIG_TINNO_CPU_TRACE */
