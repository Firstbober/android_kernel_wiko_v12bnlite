...
#if defined USER_EXTERNAL_PA || defined  EXTERNAL_PA_DRIVER_YANGLIANG  //defined(CONFIG_PROJECT_P7701) || defined(CONFIG_PROJECT_P7705)
...
static void wcd_mbhc_set_and_turnoff_hph_padac(struct wcd_mbhc *mbhc)
{
	...
	* removal event to sync-up PA's state */
	...
	#if defined USER_EXTERNAL_PA   //defined(CONFIG_PROJECT_P7701) || defined(CONFIG_PROJECT_P7705)
