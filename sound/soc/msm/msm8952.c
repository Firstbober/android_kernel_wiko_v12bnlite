...
//++ camera selfie stick & external pa TN:peter
#if defined CONFIG_USER_EXTERNAL_PA_SUSPORT
#define USER_EXTERNAL_PA
#endif

#if defined CONFIG_CAMERA_SELFIE_STICK_SUSPORT
#define CAMERA_SELFIE_STICK
#endif
//-- camera selfie stick & external pa

//tinno caoming add pa mode 5
#if defined CONFIG_USER_EXTERNAL_PA_MODE_5
#define USER_EXTERNAL_PA_MODE_5
#endif	
...
#if defined EXTERNAL_PA_DRIVER_YANGLIANG  //defined(CONFIG_PROJECT_P7701) || defined(CONFIG_PROJECT_P7705) || defined(CONFIG_PROJECT_P7203)
			...
			struct msm8916_asoc_mach_data *pdata)
{
	...
	#endif
	#if defined EXTERNAL_PA_DRIVER_YANGLIANG  //defined(CONFIG_PROJECT_P7701) || defined(CONFIG_PROJECT_P7705)
	...
	if ((pdata->spk_ext_pa_gpio < 0)) {//yangliang add for pa compatible20170112
		...
		if (!gpio_is_valid(pdata->spk_ext_pa_gpio)) {//yangliang add for pa compatible20170112
			pr_err("%s: Invalid external speaker gpio: %d",
				__func__, pdata->spk_ext_pa_gpio);
			return -EINVAL;
		}
...
static int enable_spk_ext_pa(struct snd_soc_codec *codec, int enable)
{
	...
	if (enable) {
		...
		#if defined USER_EXTERNAL_PA  //defined(CONFIG_PROJECT_P7701) || defined(CONFIG_PROJECT_P7705) || defined(CONFIG_PROJECT_P7203)
			 #ifdef USER_EXTERNAL_PA_MODE_5
				printk(KERN_ERR"goto mode-5");
...
#undef S
	...
	//try to use this configuration all project:7705 7203 9031 7771 TN:peter 
	#if 1// defined CONFIG_PROJECT_P7705 ||defined CONFIG_PROJECT_P7203//TN:peter
	btn_low[0] = 110;
	btn_high[0] = 110;
	btn_low[1] = 200;
	btn_high[1] = 200;
...
static struct snd_soc_dai_link msm8952_dai[] = {
	...
	#ifdef CONFIG_SND_SOC_QUIN_MI2S //TN:peter
	{ /* hw:x,37 */
		...
		#ifdef CONFIG_PROJECT_P7771 //TN:peter		
		.codec_dai_name = "tfa98xx-aif-2-34",//"tfa98xx_codec",yangliang change old name to new name;20161026
		.codec_name = "tfa98xx.2-0034",//it is from tfa98xx.c tfa98xx_i2c_driver`s  .name = "tfa98xx",  ;yangliang
		#endif
